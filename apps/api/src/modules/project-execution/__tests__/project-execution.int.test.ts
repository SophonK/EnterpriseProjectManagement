...
import type { ConfigService } from "../../../../../../node_modules/@nestjs/config/dist/config.service.js";
...
const PORT_MGR_TOKEN   = makeFakeJwt({ userId: "user-port-mgr",  roles: ["PORTFOLIO_MANAGER"] });
